import { type FloatArray, type IntArray, NavMesh, type OffMeshConnectionParams, type RawModule, RecastBuildContext, RecastChunkyTriMesh, type RecastCompactHeightfield, type RecastConfig, type RecastContourSet, type RecastHeightfield, type RecastPolyMesh, type RecastPolyMeshDetail, type UnsignedCharArray, type Vector3Tuple } from '@recast-navigation/core';
import type { Pretty } from '../types';
import { type OffMeshConnectionGeneratorParams } from './common';
