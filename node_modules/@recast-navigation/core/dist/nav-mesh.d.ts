 ...
 */
export declare const getNavMeshPositionsAndIndices: (navMesh: NavMesh, flags?: number) => [positions: number[], indices: number[]];
/**
 ...
 * ```
 */
export declare const floodFillPruneNavMesh: (navMesh: NavMesh, startPolyRefs: number[]) => void;
