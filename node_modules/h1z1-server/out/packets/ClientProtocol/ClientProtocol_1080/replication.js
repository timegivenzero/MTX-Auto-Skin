...
exports.replicationPackets = void 0;
exports.packComponentNameString = packComponentNameString;
exports.packClientNpcComponent = packClientNpcComponent;
exports.packClientInteractComponent = packClientInteractComponent;
exports.packNpcComponent = packNpcComponent;
const shared_1 = require("./shared");
function packComponentNameString(name) {
    const stringBuffer = Buffer.from(name.trim(), "ascii"), nullBuffer = Buffer.from([0x00]), lengthBuffer = Buffer.alloc(2);
    lengthBuffer.writeUInt16LE(stringBuffer.length, 0);
    return Buffer.concat([lengthBuffer, stringBuffer, nullBuffer]);
}
function packClientNpcComponent(obj) {
    const raw = Buffer.alloc(78);
    if (obj["nameId"]) {
...
function packClientInteractComponent(obj) {
...
function packNpcComponent(obj) {
    switch (obj.componentName) {
        ...
        default:
            throw new Error(`Unknown componentName for NPC component: ${obj.componentName}`);
    }
}
exports.replicationPackets = [
    [
