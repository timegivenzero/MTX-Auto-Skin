...
exports.groupPackets = void 0;
exports.packRemoveMember = packRemoveMember;
const h1z1_dataschema_1 = __importDefault(require("h1z1-dataschema"));
const shared_1 = require("./shared");
const groupCharacterSchema = [
    { name: "characterId", type: "uint64string", defaultValue: "" },
    {
        name: "identity",
        type: "schema",
        fields: shared_1.identitySchema,
        defaultValue: {}
    },
    { name: "unknownByte1", type: "uint8", defaultValue: 0 },
    { name: "unknownString1", type: "string", defaultValue: "" }
];
const inviteDataSchema = [
...
function packRemoveMember(obj) {
    ...
    if (obj.unknownDword2 == 4) {
        return h1z1_dataschema_1.default.pack([...unknownData1Schema, ...unknownData2Schema], obj)
            .data;
    }
    return h1z1_dataschema_1.default.pack(unknownData1Schema, obj).data;
}
exports.groupPackets = [
    [
        "Group.Invite",
        0x1301,
        {
