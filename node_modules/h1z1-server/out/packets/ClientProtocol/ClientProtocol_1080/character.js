        ...
        0x0f04,
        {
            fields: [
                ...
                },
                {
                    name: "animationName",
                    type: "custom",
                    parser: shared_1.pack2ByteLengthString,
                    packer: shared_1.pack2ByteLengthString
                },
        ...
        0x0f13,
        {
            fields: [
                ...
                { name: "unknownBoolean1", type: "boolean", defaultValue: false },
                {
                    ...
                    type: "array",
                    defaultValue: [],
                    fields: shared_1.playerCustomizationSchema
                }
            ]
        }
    ],
        ...
        0x0f2c,
        {
            fields: [
                { name: "guid", type: "uint64string", defaultValue: "0" },
                {
                    name: "unknownData1",
                    type: "schema",
                    fields: shared_1.damageReportPlayerInfoSchema
                },
                {
                    name: "unknownData2",
                    type: "schema",
                    fields: shared_1.knockedOutItemData
                },
                {
                    name: "unknownData3",
                    type: "schema",
                ...
                ...shared_1.damageReportPlayerInfoSchema
            ]
        }
    ],
    [
        ...
        0x0f2d,
        {
            fields: [
                ...
                },
                {
                    name: "unknownArray2",
                    type: "array",
                    fields: shared_1.knockedOutPlayerProfileData
                },
                {
                    name: "unknownArray3",
                    type: "array",
            ...
            fields: [
                {
                    name: "data",
                    type: "custom",
                    parser: shared_1.packMultiStateDeathData,
                    packer: shared_1.packMultiStateDeathData
                }
            ]
        }
    ],
