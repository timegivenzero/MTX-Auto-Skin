...
exports.lobbyDataSchema = exports.playerCustomizationSchema = exports.mountSchema = exports.vehicleStatSchema = exports.itemCollectionSchema = exports.emoteItemsSchema = exports.skinItemsSchema = exports.skinItemSchema = exports.accountItemsSchema = exports.escrowAccountItemsSchema = exports.listEscrowAccountItemSchema = exports.escrowAccountItemSchema = exports.accountItemSchema = exports.knockedOutItemData = exports.knockedOutPlayerProfileData = exports.damageReportPlayerInfoSchema = exports.storeBundleSchema = exports.passengerSchema = exports.firemodesSchema = exports.loadoutSlotsSchema = exports.loadoutSlotData = exports.itemDefinitionSchema = exports.equipmentSlotSchema = exports.equipmentCharacterSchema = exports.recipeData = exports.skyData = exports.containers = exports.containerData = exports.respawnLocationSchema = exports.fullPcSchema = exports.fullNpcSchema = exports.remoteWeaponExtraSchema = exports.remoteWeaponSchema = exports.attachmentSchema = exports.characterResourceData = exports.achievementSchema = exports.objectiveSchema = exports.collectionsSchema = exports.rewardBundleSchema = exports.currencySchema = exports.itemWeaponDetailSubSchema2 = exports.itemWeaponDetailSubSchema1 = exports.statSchema = exports.effectTagsSchema = exports.lightWeightNpcSchema = exports.lightWeightPcSchema = exports.identitySchema = exports.itemSchema = exports.vehicleReferenceSchema = exports.profileSchema = void 0;
exports.broadcastSchema = exports.interactionDataSchema = exports.interactionExtraTimerSchema = exports.interactionTimerSchema = exports.skillPointDataSchema = void 0;
...
exports.readAbilityInitData = readAbilityInitData;
exports.packAbilityInitData = packAbilityInitData;
exports.readAbilityUpdateData = readAbilityUpdateData;
exports.readPositionUpdateData = readPositionUpdateData;
exports.readPositionUpdateDataAndCheckLength = readPositionUpdateDataAndCheckLength;
exports.packPositionUpdateData = packPositionUpdateData;
exports.packMultiStateDeathData = packMultiStateDeathData;
...
exports.pack2ByteLengthString = pack2ByteLengthString;
...
function readAbilityInitData(data, offset) {
    ...
    if (obj["unknownByte1"] == 128) {
        ...
        offset += 4;
        obj["hitLocation"] = data.toString("utf8", offset, offset + obj["stringLength"]);
...
function packAbilityInitData(obj) {
...
function readAbilityUpdateData(data, offset) {
    const obj = {}, startOffset = offset;
    obj["unknownDword11"] = data.readUInt32LE(offset);
    offset += 4;
...
function readPositionUpdateDataAndCheckLength(data, offset) {
    const obj = {}, startOffset = offset;
    obj.raw = data.slice(1);
    obj["flags"] = data.readUInt16LE(offset);
    offset += 2;
...
function packMultiStateDeathData(obj) {
...
function packFullNPCRemoteWeaponsData(obj) {
    ...
    if (!obj.isVehicle) {
        return h1z1_dataschema_1.default.pack([], {}).data;
    }
    return h1z1_dataschema_1.default.pack(remoteWeaponsSchema, { remoteWeapons: obj }).data;
}
...
function pack2ByteLengthString(string) {
...
exports.damageReportPlayerInfoSchema = [
...
exports.knockedOutPlayerProfileData = [
    { name: "unknownQword1", type: "uint64string", defaultValue: "0" },
    { name: "unknownString1", type: "string", defaultValue: "" },
    { name: "unknownString2", type: "string", defaultValue: "" },
    { name: "unknownString3", type: "string", defaultValue: "" },
...
exports.escrowAccountItemSchema = [
    {
        name: "itemData",
        type: "schema",
        defaultValue: {},
        fields: exports.accountItemSchema
    },
    { name: "unknownQword1", type: "uint64string", defaultValue: "0" },
    { name: "unknownDword1", type: "uint32", defaultValue: 0 }
];
exports.listEscrowAccountItemSchema = [
    {
        name: "itemId",
        type: "uint64string",
        defaultValue: ""
...
exports.escrowAccountItemsSchema = [
    {
        name: "escrowAccountItems",
        type: "array",
        defaultValue: [],
        fields: exports.listEscrowAccountItemSchema
    }
];
exports.accountItemsSchema = [
    {
        name: "accountItems",
        type: "schema",
        defaultValue: {},
...
exports.skinItemsSchema = [
    {
        ...
        fields: [
            { name: "unknownDword1", type: "uint32", defaultValue: 0 },
            { name: "itemData", type: "schema", fields: exports.skinItemSchema }
        ]
    }
];
// sub_140381090
exports.emoteItemsSchema = [
    {
        name: "emotes",
        type: "array",
        defaultValue: [],
...
exports.playerCustomizationSchema = [
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    { name: "unknownString1", type: "string", defaultValue: "" },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 }
];
exports.lobbyDataSchema = [
    { name: "unknownDword1", type: "uint32", defaultValue: 0 },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    {
...
exports.interactionTimerSchema = [
    {
        name: "timeData",
        type: "schema",
        defaultValue: {},
...
exports.interactionExtraTimerSchema = [
    {
        name: "extraData",
        type: "schema",
        defaultValue: {},
