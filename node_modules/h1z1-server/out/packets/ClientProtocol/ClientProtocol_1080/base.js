...
exports.basePackets = [
                    ...
                    fields: [
                        ...
                        { name: "unknownDword37", type: "uint32", defaultValue: 0 },
                        {
                            ...
                            fields: [
                                ...
                                ...shared_1.interactionDataSchema,
                                { name: "unknownByte1", type: "uint8", defaultValue: 0 }
                            ]
                        },
                        {
                        ...
                        ...shared_1.accountItemsSchema,
                        ...shared_1.escrowAccountItemsSchema,
                        {
                            name: "unknownData7",
                            type: "schema",
                            defaultValue: {},
                        ...
                        },
                        {
                            ...
                            fields: [
                                ...
                                { name: "unknownDword2", type: "uint32", defaultValue: 0 },
                                { name: "unknownString1", type: "string", defaultValue: "" },
                                ...shared_1.skinItemsSchema,
                                ...shared_1.emoteItemsSchema,
                                ...shared_1.itemCollectionSchema
                            ]
                        },
                        {
                            name: "loadoutSlots",
    ...
    [
        ...
        0x2e0000,
        {
            fields: shared_1.broadcastSchema
        }
    ],
    [
        "Broadcast.Zone",
        ...
        0x91,
        {
            fields: [
                ...
                },
                {
                    name: "positionUpdate",
                    type: "custom",
                    parser: shared_1.readPositionUpdateDataAndCheckLength,
                    packer: shared_1.packPositionUpdateData,
                    defaultValue: 1
                }
            ]
