...
function getHeadActor(modelId) {
    switch (modelId) {
        case enums_1.ModelIds.SURVIVOR_MALE_HEAD_01:
            return "SurvivorMale_Head_01.adr";
        case enums_1.ModelIds.SURVIVAL_FEMALE_HEAD_01:
            return "SurvivorFemale_Head_01.adr";
        case enums_1.ModelIds.ZOMBIE_FEMALE_HEAD:
            return `ZombieFemale_Head_0${Math.floor(Math.random() * 2) + 1}.adr`;
        case enums_1.ModelIds.ZOMBIE_MALE_HEAD:
...
class BaseLightweightCharacter extends baseentity_1.BaseEntity {
     ...
     */
    positionUpdateType = enums_1.PositionUpdateType.STATIC;
    ...
    pGetSimpleProxyHealth() {
        ...
        return {
            characterId: this.characterId,
            healthPercentage: this.actorModelId == enums_1.ModelIds.HAND_SHOVEL
                ? 100
