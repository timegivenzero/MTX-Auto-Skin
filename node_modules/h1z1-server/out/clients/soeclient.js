...
const EventEmitter = require("node:events").EventEmitter, SOEInputStream = require("../servers/SoeServer/soeinputstream").SOEInputStream, SOEOutputStream = require("../servers/SoeServer/soeoutputstream").SOEOutputStream, { Soeprotocol, append_crc_legacy, SoeOpcode } = require("h1emu-core"), util = require("node:util"), fs = require("node:fs"), dgram = require("node:dgram"), debug = require("debug")("SOEClient");
...
class SOEClient {
    constructor(protocolName, serverAddress, serverPort, cryptoKey, localPort) {
        ...
        outputStream.on(SOEOutputChannels.Reliable, function (data, sequence, fragment) {
            if (fragment) {
        ...
        function checkOutOfOrderQueue() {
            if (outOfOrderPackets.length) {
                ...
                me._sendPacket(SoeOpcode.MultiPacket, {
                    subPackets: packets
                }, true);
            }
    ...
    _sendPacket(packetOpcode, packet, prioritize) {
        ...
        const data = Buffer.from(this._protocol.pack(packetOpcode, JSON.stringify(packet)));
